...
<head>
	...
	<style type="text/css">
		...
		#header .brand {font-family:microsoft yahei, Helvetica, Georgia, Arial, sans-serif, 黑体;font-size:26px;padding-left:33px;}
	...
	<div id="main">
	    ...
	    <div class="container-fluid">
		    ...
		    <div id="footer" class="row-fluid">
	            Copyright &copy; 2015-${fns:getConfig('copyrightYear')} ${fns:getConfig('productName')} - Powered By <a href="http://www.pincai360.com" target="_blank">PinCai360</a> ${fns:getConfig('version')}
			</div>
		</div>
	</div>
	<script type="text/javascript"> 
