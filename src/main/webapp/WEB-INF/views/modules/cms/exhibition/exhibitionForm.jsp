...
// 		function areaSelect(parentId, selectId){
// 			$("#"+selectId).empty();
// 			var optionNull = $("<option>").val("").text("请选择");
// 		    $("#"+selectId).append(optionNull);
// 			if(parentId == "")  return;
// 			jQuery.ajax( {  
// 		        type : 'GET',  
...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/cms/exhibition/list?chanId=${chanId}">展会列表</a></li>
		<li class="active"><a href="${ctx}/cms/exhibition/form?id=${exhibition.id}&chanId=${chanId}">展会<shiro:hasPermission name="cms:exhibition:edit">${not empty exhibition.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="cms:exhibition:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="exhibition" action="${ctx}/cms/exhibition/save?chanId=${chanId}" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<label style="padding-top:3px;">${exhibition.channelPathName }</label>
			</div>
		</div>
		<div class="control-group">
...
<%-- 				</form:select> --%>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="qq" htmlEscape="false" maxlength="50" class="input-xlarge digits"/>
			</div>
		</div>
		<div class="control-group">
