...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			var zNodes=[
		            <c:forEach items="${channelList}" var="tpl">{id:'${tpl.id}', pId:'${tpl.parentId}', name:"${tpl.name}", url:"${ctx}/cms/exhibition/auditList?chanId=${tpl.id}", target:"exhibitionAuditMainFrame"},
		            </c:forEach>];
