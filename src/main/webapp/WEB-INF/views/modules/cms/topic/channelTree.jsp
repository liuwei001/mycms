...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			var zNodes=[
		            <c:forEach items="${channelList}" var="tpl">{id:'${tpl.id}', pId:'${tpl.parentId}', name:"${tpl.name}", url:"${ctx}/cms/topic/contentList?channelId=${tpl.id}&topicId=${topicId}", target:"topicContentMainFrame"},
		            </c:forEach>];
...
<body>
	<div class="accordion-group">
	    <div class="accordion-heading">
	    	<a class="accordion-toggle">新闻分类列表</a>
	    </div>
