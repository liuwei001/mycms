...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/cms/content/spiderList">新闻列表</a></li>
		<li class="active"><a href="${ctx}/cms/content/spiderForm?id=${content.id}">新闻<shiro:hasPermission name="cms:content:edit">${not empty content.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="cms:content:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="content" action="${ctx}/cms/content/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<sys:treeselect id="channel" name="channelId" value="${content.channelId}" labelName="channelName" labelValue="${content.channelPathName}"
					title="新闻分类" url="/cms/content/treeData" notAllowSelectRoot = "true"/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="shortTitle" htmlEscape="false" maxlength="50" class="input-xlarge"/>
			</div>
		</div>
		<div class="control-group">
