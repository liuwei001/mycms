 ...
 */
package com.qr.ecomm.common.web;

import javax.servlet.ServletConfig;
import javax.servlet.http.HttpServletRequest;

import com.qr.ecomm.common.config.Global;
import com.qr.ecomm.common.utils.FileUtils;
...
//			this.baseURL = ServletContextFactory.getServletContext().getContextPath()+"/userfiles/"+principal+"/";
			...
			this.baseDir = FileUtils.path4Absolute(Global.getUserfilesBaseDir() + Global.USERFILES_BASE_URL + principal + "/");
		} catch (Exception e) {
