...
import com.qr.ecomm.common.persistence.generic.ETreeDao;
import com.qr.ecomm.common.persistence.generic.ETreeEntity;
...
public abstract class ETreeService<D extends ETreeDao<T, E>, T extends ETreeEntity<T, E>, E> extends ECrudService<D, T, E> {
