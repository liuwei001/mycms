...
import com.qr.ecomm.common.persistence.longid.LTreeDao;
import com.qr.ecomm.common.persistence.longid.LTreeEntity;
...
public abstract class LTreeService<D extends LTreeDao<T>, T extends LTreeEntity<T>> extends LCrudService<D, T> {
