 ...
 */
package com.qr.ecomm.common.utils;
...
import com.qr.ecomm.common.utils.os.OSinfo;
...
public class FileUtils extends org.apache.commons.io.FileUtils {
	 ...
	 * @return
	 */
	public static String path4Absolute(String path){
		String tmp = StringUtils.replace(path, "\\", "/");
		String p = StringUtils.join(StringUtils.split(tmp, "/"), "/");
		if( (!OSinfo.isWindows()) && StringUtils.indexOf(tmp, "/")  == 0 ){
			p = "/" + p;
		}
		if (!StringUtils.startsWithAny(p, "/") && StringUtils.startsWithAny(path, "\\", "/")){
			p += "/";
